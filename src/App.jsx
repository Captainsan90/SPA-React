...
function App() {
  ...
  const [projects, setProjects] = useState([
    { id: 1, title: "Project 1:Kiwi", description: "Social Media Marketing for Kiwi" },
    { id: 2, title: "Project 2:Samsung", description: "Print Media Advertisement Samsung" },
    { id: 3, title: "Project 3:Toyota", description: "Billboards for Toyota in Nairobi" },
  ]);
